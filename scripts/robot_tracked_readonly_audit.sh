...
echo 'BLOCKED: legacy tracked-base field audit is permanently retired.' >&2
echo 'Use the current ROS1/Noetic read-only authorization and evidence collector.' >&2
exit 64
